    ...
    >
      <div className="bucket-minibar-inner">
        <a className="bucket-minibar-logo" onClick={(e) => e.preventDefault()}>
          <img src={sidebarColorSet.mode === 'dark' ? '/assets/images/logo-white.png' : '/assets/images/logo.png'} alt="crema-logo" />
        </a>

        <AppScrollbar className="bucket-minibar-scrollbar" scrollToTop={false}>
          <div className="bucket-minibar-main">
            <a className="bucket-minibar-link" onClick={(e) => e.preventDefault()}>
              <AiOutlineSearch />
            </a>
            ...
            <a className="bucket-minibar-link bucket-minibar-notify-link" onClick={(e) => e.preventDefault()}>
