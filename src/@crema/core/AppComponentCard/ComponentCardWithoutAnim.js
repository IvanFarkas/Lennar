...
const ComponentCardWithoutAnim = ({ title, description, className, maxHeight, component: Component, source }) => {
  ...
  return (
    <AppCard
      ...
      title={
        <>
          <span>{title}</span>
          <span className="comp-card-title-description text-truncate">{description}</span>
        </>
      }
      extra={
        source ? (
