...
const AppsContainer = (props) => {
  ...
  return (
    <div className="apps-wrap">
      ...
      >
        {fullView ? null : (
          <Button className="menu-btn" onClick={() => setAppDrawerOpen(!isAppDrawerOpen)}>
      ...
      <div className="apps-container">
        {sidebarContent ? (
          <QueueAnim style={{ zIndex: 3 }} type={props.type ? props.type : 'left'}>
            <AppSidebar isAppDrawerOpen={isAppDrawerOpen} setAppDrawerOpen={setAppDrawerOpen} footer={footer} fullView={fullView} navStyle={navStyle} sidebarContent={sidebarContent} key="sidebar" />
          </QueueAnim>
        ) : null}
        <div
        ...
        >
          {noContentAnimation ? (
            ...
            <QueueAnim type={props.type ? props.type : 'right'} style={{ minHeight: '100%' }}>
              <Card
                bordered={false}
                key="content"
                className="apps-main-content-card"
