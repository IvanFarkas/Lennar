...
const AppSidebar = (props) => {
  ...
  return (
    <div className="apps-sidebar">
      <Drawer closeIcon={null} placement={direction === ThemeDirection.LTR ? 'left' : 'right'} visible={isAppDrawerOpen} onClose={() => setAppDrawerOpen(!isAppDrawerOpen)} className="apps-sidebar-drawer">
        {sidebarContent}
      </Drawer>
