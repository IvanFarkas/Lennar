...
const AppPageMetadata = ({ children, ...rest }) => {
  ...
  const getMetaTags = ({ title, description, image, contentType, twitter, noCrawl, published = '10-01-2022', updated, category = 'Lennar, Dashboard, ', tags = 'Lennar, Dashboard, ' }, pathname) => {
