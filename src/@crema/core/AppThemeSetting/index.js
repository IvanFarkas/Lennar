...
const AppThemeSetting = () => {
  ...
  return (
    <div className="customizer-option">
      <Button className="customizer-btn" onClick={() => setCustomizerStatus(!open)}>
          ...
          <div className="customize-main">
            ...
            <div className="customize-item">
              <div className="customize-switch-view">
                ...
                <Switch className="customize-switch" checked={direction === ThemeDirection.RTL} onChange={onChangeRtlSetting} value="checkedA" />
              </div>
            </div>
            ...
            <div className="customize-item">
              ...
              <div className="customize-nav-option">
                {navStyles.map((navLayout) => {
                  return (
                    <div className="customize-nav-option-item" key={navLayout.id}>
                      <div className="customize-nav-option-content" onClick={() => onNavStyleChange(navLayout.alias)}>
                ...
                {layoutTypes.map((layout) => {
                  return (
                    <div className="customize-nav-option-item" key={layout.id}>
                      <div className="customize-nav-option-content" onClick={() => onLayoutChange(layout.alias)}>
            ...
            <div className="customize-item">
              <div className="customize-switch-view">
                <h4>Footer</h4>
                <Switch className="customize-switch" checked={footer} onChange={(value) => setFooter(value)} value="checkedA" />
              </div>
            </div>
