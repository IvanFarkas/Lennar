...
const MenuColorCell = ({ sidebarColors }) => {
  ...
  const { sidebarBgColor, sidebarTextColor, sidebarMenuSelectedBgColor, sidebarMenuSelectedTextColor } = sidebarColorSet;
  ...
  return (
    <div
      ...
      style={{
        border: sidebarColors.mode === ThemeMode.LIGHT ? `solid 2px ${defaultConfig.sidebar.borderColor}` : `solid 2px ${sidebarColors.sidebarBgColor}`,
      }}
    ...
    >
      ...
      >
        ...
        <div
          className={clsx('menu-color-cell-menu-item menu-color-cell-menu-item-selected', {
      ...
      {sidebarColors.sidebarBgColor === sidebarBgColor && sidebarColors.sidebarTextColor === sidebarTextColor && sidebarColors.sidebarMenuSelectedBgColor === sidebarMenuSelectedBgColor && sidebarColors.sidebarMenuSelectedTextColor === sidebarMenuSelectedTextColor ? <AppSelectedIcon isCenter={false} backgroundColor={sidebarMenuSelectedBgColor} color={sidebarMenuSelectedTextColor} /> : null}
    </div>
  );
};
