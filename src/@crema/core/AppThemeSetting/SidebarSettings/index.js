    ...
    <div className="sidebar-setting">
      ...
      <div className="customize-item">
        <div className="customize-switch-view">
          ...
          <Switch className="customize-switch" checked={isSidebarBgImage} onChange={onToggleSidebarImage} value="checkedA" />
        </div>
            ...
            {sidebarBgImages.map((imagesObj) => {
              return (
                <div className="customize-nav-option-item" key={imagesObj.id}>
                  <div className="customize-nav-option-content" onClick={() => onUpdateSidebarBgImage(imagesObj.id)}>
      ...
      <div className="customize-item">
        ...
        <AppGrid data={sidebarColors} column={2} itemPadding={5} renderItem={(colorSet, index) => <MenuColorCell key={index} sidebarColors={colorSet} />} />
      </div>
    </div>
  );
};
