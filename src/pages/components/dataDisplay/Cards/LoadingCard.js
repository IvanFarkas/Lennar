  ...
  render() {
    ...
    return (
      <Space direction="vertical">
        ...
        <Card className="loading-card" style={{ width: 300, marginTop: 16 }} loading={loading}>
        ...
        <Card className="loading-card" style={{ width: 300, marginTop: 16 }} actions={[<SettingOutlined key="setting" />, <EditOutlined key="edit" />, <EllipsisOutlined key="ellipsis" />]}>
