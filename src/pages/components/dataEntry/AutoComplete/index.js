...
const AutoComplete = () => {
  return (
    <>
      <ComponentHeader title="Auto Complete" refUrl="https://ant.design/components/auto-complete/" />
      <AppRowContainer>
        ...
        <Col xs={24} lg={12} key="complete-b">
          <AppComponentCard title="Customized" component={Customized} source={CustomizedSource} />
        </Col>
        <Col xs={24} lg={12} key="complete-c">
          <AppComponentCard title="Customize Input Component" component={CustomizeInputComponent} source={CustomizeInputComponentSource} />
        </Col>
        <Col xs={24} lg={12} key="complete-d">
          <AppComponentCard title="LookupPatterns" component={LookupPatterns} source={LookupPatternsSource} />
        </Col>
        <Col xs={24} lg={12} key="complete-e">
          <AppComponentCard title="Non Case Sensitive Auto Complete" component={NonCaseSensitiveAutoComplete} source={NonCaseSensitiveAutoCompleteSource} />
        </Col>
      </AppRowContainer>
    </>
  );
