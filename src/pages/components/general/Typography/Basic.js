...
const Basic = () => {
  return (
    <Typography>
      ...
      <Title>Introduction</Title>
      <Paragraph>
        Ant&apos;s enterprise-level products are a huge and complex system. Such products are not only huge in magnitude and complex in function, but also frequent changes and concurrency, and often require design and development to be able to respond quickly. At the same time, there are many similar pages and components in such products, and some stable and highly reusable content can be obtained
        through abstraction.
      </Paragraph>
      <Paragraph>
        With the trend of commercialization, more and more enterprise-level products have further requirements for better user experience. With such an ultimate goal, we (Ant Financial Experience Technology Department) have gradually polished a design system that serves enterprise-level products after a lot of project practice and summary Ant Design. Based on{' '}
        <Text mark> &apos;OK&apos; and &apos;Natural&apos;</Text>
        Design values, through modular solutions to reduce redundant production costs, allowing designers to focus on
        <Text strong>Better user experience</Text>.
      </Paragraph>
      <Title level={2}>Design resources</Title>
      <Paragraph>
        We provide comprehensive design principles, best practices and design resource documents (<Text code>Sketch</Text> and <Text code>Axure</Text>) To help the business quickly design high-quality product prototypes
      </Paragraph>

      <Paragraph>
        <ul>
          <li>
            <Link href="https://ant.design/docs/spec/proximity-cn">Design Principles</Link>
          </li>
          <li>
            <Link href="https://ant.design/docs/spec/overview-cn">Design Patterns</Link>
          </li>
          <li>
            <Link href="https://ant.design/docs/resources-cn">Design resources</Link>
          </li>
        </ul>
      </Paragraph>
