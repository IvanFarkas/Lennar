...
const authorizedStructure = {
  ...
  routes: [...dashboardConfig, ...ecommerceConfig, ...extraPagesConfigs, ...componentsConfigs, ...thirdPartyConfigs, ...userPagesConfig, ...appsConfig, ...menuLevelConfig, ...userListConfig, ...profileConfig],
};
