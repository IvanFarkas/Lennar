      ...
      <AppRowContainer gutter={16}>
        ...
        <Col xs={24} md={12}>
          <Form.Item name="country" rules={[{ required: true, message: 'Please input Your Country!' }]}>
            <Select showSearch style={{ width: '100%' }} placeholder="Select a country" optionFilterProp="children" filterOption={(input, option) => option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0}>
