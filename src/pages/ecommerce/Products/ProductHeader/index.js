  ...
  return (
    <div className="product-header">
      <div className="product-header-left">
        <h3>Watches</h3>
        <span className="product-header-showing-text text-truncate">(Showing 1 – 40 products of 93,723 products)</span>
      </div>
      <div className="product-header-right">
        <Search className="product-header-search" placeholder="Search here" onChange={(e) => onChange(e.target.value)} />
