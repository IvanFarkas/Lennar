...
const ProductListing = () => {
  ...
  return (
    <div className="product-list-view">
      ...
      <AppsContent>
        <div className="product-list-main-content">{viewType === VIEW_TYPE.GRID ? <ProductGrid ecommerceList={ecommerceList} loading={loading} /> : <ProductList ecommerceList={ecommerceList} loading={loading} />}</div>
      </AppsContent>
    </div>
  );
};
