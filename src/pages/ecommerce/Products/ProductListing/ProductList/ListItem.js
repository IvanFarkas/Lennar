        ...
        <div className="product-list-slider-content">
          ...
          <div className="product-list-price">
            <div className="product-list-price-item">
              ...
              <span className="product-list-price-item-value">${+item.mrp - Math.round((+item.mrp * +item.discount) / 100)}</span>
            </div>
            <div className="product-list-price-item">
              <IntlMessages id="ecommerce.mrp" />:<span className="product-list-price-item-value-cut">${item.mrp}</span>
            </div>
