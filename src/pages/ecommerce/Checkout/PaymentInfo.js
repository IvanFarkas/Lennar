...
const PaymentInfo = () => {
  ...
  return (
    <AppCard title={<h3 className="checkout-card-title">Payment Info</h3>} actions={<Button type="primary">Place Order</Button>}>
        ...
        {paymentMode === 'CARD' ? (
          <div className="pay-mode-content">
            ...
            <div className="pay-mode-form-field">
              <div className="form-field">
                <Input id="expiry-date" placeholder="Expiry Date (MM/YY)" type="search" />
              </div>
              <div className="form-field">
      ...
      <div className="payment-info-item">
        <span onClick={() => setPaymentMode('PAYPAL')} className="pay-radio-mod">
          <Radio checked={paymentMode === 'PAYPAL'}>PAYPAL</Radio>
        </span>
        {paymentMode === 'PAYPAL' ? (
          <div className="pay-mode-content">
            <div className="form-field">
              <Input id="paypal-email" placeholder="PayPal email address" type="search" />
            </div>
          </div>
        ) : null}
      </div>
