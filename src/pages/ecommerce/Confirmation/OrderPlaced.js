        ...
        <Col xs={24} lg={16}>
          <div className="order-placed-info">
            ...
            <div className="order-placed-content">
              ...
              <p className="mb-0">Your {cartItems.length} Item will be delivered by Mon, 27 Aug 20.</p>
            </div>
          </div>
        </Col>
        <Col xs={24} lg={8}>
          <div className="order-placed-action">
            ...
            <div className="order-placed-action-thumb">
              <img style={{ maxHeight: 60, marginTop: 20 }} src={'/assets/images/ecommerce/confirm-box.png'} alt="confirm" />
            </div>
          </div>
        </Col>
      </AppRowContainer>
