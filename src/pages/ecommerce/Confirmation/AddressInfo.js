          ...
          <div className="confirmation-address-item">
            ...
            <div className="confirmation-address-reward">
              <div className="confirmation-address-reward-row">
                ...
                <p className="confirmation-address-reward-title">SMS updates at every step</p>
              </div>
              <Button type="primary" className="confirmation-address-reward-btn">
                Subscribe
              </Button>
            </div>
            ...
            <div className="confirmation-address-reward">
              <div className="confirmation-address-reward-row">
                ...
                <p className="confirmation-address-reward-title">Order shared with 1 Person</p>
              </div>
              <Button type="primary" className="confirmation-address-reward-btn">
                Manage
              </Button>
