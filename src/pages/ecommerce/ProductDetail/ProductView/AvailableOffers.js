    ...
    <div className="product-detail-available-offer">
      ...
      <p className="product-detail-available-offer-item">
        ...
        <span className="product-detail-available-offer-item-inner">
          <span className="product-detail-available-offer-para">Special PriceGet extra ₹598 off (price inclusive of discount)</span>
          <span>T&C</span>
        </span>
      </p>
      ...
      <p className="product-detail-available-offer-item">
        ...
        <span className="product-detail-available-offer-item-inner">
          <span className="product-detail-available-offer-para">No cost EMI ₹1,368/month. Standard EMI also available</span>
