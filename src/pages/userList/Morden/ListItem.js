        ...
        <div className="user-morden-content">
          <div className="user-morden-header">
            ...
            <div className="user-morden-header-action">
              <span className="user-morden-header-action-item">
                <Tooltip className="pointer" title={<IntlMessages id="common.share" />}>
                  <ShareAltOutlined />
                </Tooltip>
              </span>

              <span className="user-morden-header-action-item">
                <Tooltip className="pointer" title={<IntlMessages id="common.bookmark" />}>
                  <BookOutlined />
                </Tooltip>
              </span>

              <span className="user-morden-header-action-item">
                <Tooltip className="pointer" title={<IntlMessages id="common.more" />}>
                  <MoreOutlined />
                </Tooltip>
              </span>
            </div>
          ...
          <div className="user-morden-footer">
            ...
            <div className="user-morden-footer-action">
              ...
              <Button variant="contained" className="user-morden-footer-remove-btn">
