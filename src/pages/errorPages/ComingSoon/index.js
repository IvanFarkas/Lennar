      ...
      <div className="error-container" key="coming_soon">
        ...
        <div>
          ...
          <div className="error-form-coming">
            <Form className="error-form" name="basic" initialValues={{ remember: true }} onFinish={onFinish} onFinishFailed={onFinishFailed}>
              <Form.Item name="email" className="form-field" rules={[{ required: true, message: 'Please enter Email Address!' }]}>
