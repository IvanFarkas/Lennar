    ...
    <Card className="pricing-four-card">
      <div className="pricing-four-content">
        <div className="pricing-four-card-header">
          <div className="pricing-four-card-pricing-circle" style={{ backgroundColor: pricing.priceColor }}>
            <h3>
      ...
      <div className="pricing-four-btn-view">
        <Button className="pricing-four-btn" style={{ backgroundColor: pricing.priceColor }}>
          Get started
        </Button>
      </div>
    </Card>
