      ...
      Object.assign({}, notification, {
        ...
        content: (
          <div className="notification-custom-image">
            ...
            <span className="notification-custom-image-content">Lennar</span>
          </div>
        ),
      }),
    );
  ...
  render() {
    return (
      <div className="react-notification">
        ...
        <div className="react-notification-item">
          <Button type="primary" onClick={() => this.addCustomIcon('success', 'fas fa-check-circle')}>
            Success with Icon
          </Button>
        </div>
        <div className="react-notification-item">
          <Button type="primary" onClick={() => this.addCustomIcon('danger', 'fas fa-exclamation-circle')}>
            Danger with Icon
          </Button>
        </div>
        <div className="react-notification-item">
          <Button type="primary" onClick={() => this.addCustomIcon('warning', 'fas fa-exclamation-triangle')}>
            Warning with Icon
          </Button>
        </div>
      </div>
