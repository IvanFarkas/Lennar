...
const LineChart = () => {
  return (
    <>
      <ComponentHeader title="Line Chart" description="All svg elements can be added into the LineChart component, such as defs." refUrl="http://recharts.org/en-US/api/LineChart" />

      <AppRowSimpleContainer>
        <Col xs={24} xl={12}>
          <ComponentCard title="Simple Line Chart" component={SimpleLineChart} source={SimpleLineChartSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Vertical Line Chart" component={VerticalLineChart} source={VerticalLineChartSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Customized Dot Line Chart" component={CustomizedDotLineChart} source={CustomizedDotLineChartSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Line Chart With Reference Lines" component={LineChartWithReferenceLines} source={LineChartWithReferenceLinesSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Dashed Line Chart" component={DashedLineChart} source={DashedLineChartSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Line Chart With X-Axis Padding" component={LineChartWithXAxisPading} source={LineChartWithXAxisPadingSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Synchronized Line Chart" component={SynchronizedLineChart} source={SynchronizedLineChartSource} />
        </Col>
        <Col xs={24} xl={12}>
          <ComponentCard title="Line Chart Connect Nulls" component={LineChartConnectNulls} source={LineChartConnectNullsSource} />
        </Col>
      </AppRowSimpleContainer>
    </>
  );
