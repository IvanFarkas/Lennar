...
const PopUpInfoWindowExampleGoogleMap = withGoogleMap((props) => (
  <GoogleMap defaultZoom={15} center={props.center}>
    {props.markers.map((marker, index) => (
      <Marker defaultIcon={'/assets/images/marker.png'} key={index} position={marker.position} onClick={() => props.onMarkerClick(marker)}>
        {/*
...
export default class MapPopupInfo extends Component {
    ...
    markers: [
      {
        ...
        infoContent: (
          <div className="cr-map-popup">
            ...
            <div className="cr-map-popup-info">
  ...
  render() {
    return <PopUpInfoWindowExampleGoogleMap containerElement={<div className="cr-embed-responsive cr-embed-responsive-21by9" />} mapElement={<div className="cr-embed-responsive-item" />} center={this.state.center} markers={this.state.markers} onMarkerClick={this.handleMarkerClick} onMarkerClose={this.handleMarkerClose} />;
  }
}
