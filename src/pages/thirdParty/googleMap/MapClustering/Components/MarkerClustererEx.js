...
export default class MarkerClustererExample extends Component {
  ...
  render() {
    return <MarkerClustererExampleGoogleMap containerElement={<div className="cr-embed-responsive cr-embed-responsive-21by9" />} mapElement={<div className="cr-embed-responsive-item" />} markers={this.state.markers} />;
  }
}
