...
import { AlphaPicker, BlockPicker, ChromePicker, CirclePicker, CompactPicker, GithubPicker, HuePicker, MaterialPicker, PhotoshopPicker, SketchPicker, SwatchesPicker, TwitterPicker } from 'react-color';
...
const ColorPicker = () => {
  return (
    <>
      <ComponentHeader title="React Color" description="13 Different Pickers - Sketch, Photoshop, Chrome and many more, Use the building block components to make your own " refUrl="http://casesandberg.github.io/react-color/" />
      ...
      <AppRowSimpleContainer>
        ...
        <Col xs={24} xl={12} key="reactColor-i">
          <ComponentCard title="WithRedux Picker" component={WithRedux} source={WithReduxSource} />
        </Col>
        ...
        <Col xs={24} xl={12} key="reactColor-l">
          <ComponentCard title="Basic Picker" component={Basic} source={BasicSource} />
        </Col>
        <Col xs={24} xl={12} key="reactColor-m">
          <ComponentCard title="BasicToggle Picker" component={BasicToggle} source={BasicToggleSource} />
        </Col>
        <Col xs={24} xl={12} key="reactColor-n">
          <ComponentCard title="Custom Picker" component={CustomPicker} source={CustomPickerSource} />
        </Col>
        <Col xs={24} xl={12} key="reactColor-o">
          <ComponentCard title="CustomPointer Picker" component={CustomPointer} source={CustomPointerSource} />
        </Col>
        <Col xs={24} xl={12} key="reactColor-p">
          <ComponentCard title="BasicPositioning" component={BasicPositioning} source={BasicPositioningSource} />
        </Col>
