...
const ReactDropzone = () => {
  return (
    <>
      <ComponentHeader title="React Dropzone" description="Simple React hook to create a HTML5-compliant dragndrop zone for files." refUrl="https://react-dropzone.netlify.com/" />
      ...
      <AppRowSimpleContainer>
        ...
        <Col xs={24} xl={12} key="dropzone-b">
          <ComponentCard title="Event Propagation" component={EventPropagation} source={EventPropagationSource} />
        </Col>
        <Col xs={24} xl={12} key="dropzone-c">
          <ComponentCard title="Specific`File Types" component={SpecificFileTypes} source={SpecificFileTypesSource} />
        </Col>
        <Col xs={24} xl={12} key="dropzone-d">
          <ComponentCard title="Dialog Programmatically" component={DialogProgrammatically} source={DialogProgrammaticallySource} />
        </Col>
        <Col xs={24} xl={12} key="dropzone-e">
          <ComponentCard title="Styling Dropzone" component={StylingDropzone} source={StylingDropzoneSource} />
        </Col>
        <Col xs={24} xl={12} key="dropzone-f">
          <ComponentCard title="Previews" component={Previews} source={PreviewsSource} />
        </Col>
        <Col xs={24} xl={12} key="dropzone-g">
          <ComponentCard title="Class Components" component={ClassComponents} source={ClassComponentsSource} />
        </Col>
      </AppRowSimpleContainer>
    </>
  );
