    ...
    <div className="sign">
      ...
      <div className="sign-footer">
        ...
        <div className="sign-socialLink">
          <Button className="sign-icon-btn" icon={<GoogleOutlined />} onClick={() => auth.federatedSignIn({ provider: 'Google' })} />
          <Button className="sign-icon-btn" icon={<FaFacebookF />} onClick={() => auth.federatedSignIn({ provider: 'Facebook' })} />
        </div>
      </div>
    </div>
  );
