    ...
    <div className="sign">
      ...
      <div className="sign-footer">
        ...
        <div className="sign-socialLink">
          <Button className="sign-icon-btn" onClick={() => signInWithPopup('google')} icon={<GoogleOutlined />} />
          <Button className="sign-icon-btn" icon={<FaFacebookF />} onClick={() => signInWithPopup('facebook')} />
          <Button className="sign-icon-btn" icon={<GithubOutlined />} onClick={() => signInWithPopup('github')} />
          <Button className="sign-icon-btn" icon={<TwitterOutlined />} onClick={() => signInWithPopup('twitter')} />
        </div>
      </div>
    </div>
  );
