  ...
  return (
    <div className="signup">
      <div className="signup-content">
        <Form className="signup-form" name="basic" initialValues={{ remember: true }} onFinish={signUpCognitoUser} onFinishFailed={onFinishFailed}>
      ...
      <div className="signup-footer">
        ...
        <div className="signup-socialLink">
          <Button className="signup-icon-btn" shape="circle" onClick={() => auth.federatedSignIn({ provider: 'Google' })} icon={<GoogleOutlined />} />
          <Button className="signup-icon-btn" shape="circle" onClick={() => auth.federatedSignIn({ provider: 'Facebook' })} icon={<FaFacebookF />} />
        </div>
      </div>
    </div>
  );
