  ...
  return (
    <div className="signup">
      <div className="signup-content">
        <Form className="signup-form" name="basic" initialValues={{ remember: true }} onFinish={createUserWithEmailAndPassword}>
          <Form.Item name="name" className="form-field" rules={[{ required: true, message: 'Please input your Name!' }]}>
          ...
          <Form.Item className="form-field signup-checkbox" name="iAgreeTo" valuePropName="checked">
            <Checkbox>
      ...
      <div className="signup-footer">
        ...
        <div className="signup-socialLink">
          <Button className="signup-icon-btn" shape="circle" onClick={() => signInWithPopup('google')} icon={<GoogleOutlined />} />
          <Button className="signup-icon-btn" shape="circle" onClick={() => signInWithPopup('facebook')} icon={<FaFacebookF />} />
          <Button className="signup-icon-btn" shape="circle" icon={<GithubOutlined />} onClick={() => signInWithPopup('github')} />
          <Button className="signup-icon-btn" shape="circle" icon={<TwitterOutlined />} onClick={() => signInWithPopup('twitter')} />
        </div>
      </div>
    </div>
  );
