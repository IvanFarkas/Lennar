...
const ForgetPasswordJwtAuth = () => {
  ...
  return (
    <div className="forget-content">
      ...
      <Form className="forget-form" name="basic" initialValues={{ remember: true }} onFinish={onFinish} onFinishFailed={onFinishFailed}>
        <Form.Item name="email" className="form-field" rules={[{ required: true, message: 'Please input your Email Address!' }]}>
