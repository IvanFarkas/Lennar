        ...
        <div className="user-container" key="a">
          <Card className="user-card user-card-lg-space">
            ...
            <Form className="user-form mb-0" name="basic" initialValues={{ remember: true }} onFinish={onFinish} onFinishFailed={onFinishFailed}>
              <Form.Item name="password" className="form-field-lg" rules={[{ required: true, message: 'Please input your Password!' }]}>
                <Input type="password" placeholder={messages['common.password']} />
              </Form.Item>

              <Button type="primary" className="user-form-btn" htmlType="submit">
