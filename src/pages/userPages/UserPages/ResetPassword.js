      ...
      <AppAnimateGroup type="bottom">
        ...
        <div className="user-container" key="a">
          <Card className="user-card">
            ...
            <Form className="user-form mb-0" name="basic" initialValues={{ remember: true }} onFinish={onFinish} onFinishFailed={onFinishFailed}>
              <Form.Item name="oldPassword" className="form-field" rules={[{ required: true, message: 'Please input your Old Password!' }]}>
                <Input type="password" placeholder={messages['common.oldPassword']} />
              </Form.Item>
