...
const DoctorCell = ({ doctor }) => {
  return (
    <List.Item className="doctor-cell item-hover">
      ...
      <div className="doctor-action">{doctor.scheduled ? <Button className="btn-secondary-outline">Remove</Button> : <Button className="btn-primary-outline">Schedule</Button>}</div>
    </List.Item>
  );
};
