      ...
      <AreaChart data={data} margin={{ top: 25, right: 0, left: 0, bottom: 0 }}>
        <defs>
          <linearGradient id="colorPv" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" className="statics-graph-color" stopOpacity={0.1} />
            <stop offset="95%" className="statics-graph-color" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <Area type="monotone" dataKey="number" className="statics-graph-color" strokeWidth={3} fillOpacity={1} fill="url(#colorPv)" />
      </AreaChart>
    </ResponsiveContainer>
  );
};
