  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      <LineChart data={data} margin={{ top: 50, right: 0, left: -25, bottom: 0 }}>
        ...
        <Line type="monotone" dataKey="Consultations" stroke="#0698ec" dot={false} strokeWidth={2} activeDot={{ r: 4 }} />
        <Line type="monotone" dot={false} strokeWidth={2} dataKey="Patients" stroke="#f44d50" />
      </LineChart>
    </ResponsiveContainer>
  );
};
