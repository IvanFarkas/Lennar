...
const MetricTitleLineGraphCard = ({ title, titleColor, valueColor, differenceColor, bgColor, data, graphColor }) => {
  return (
    <AppCard className="metric-title-line-graph-card" style={{ backgroundColor: bgColor }}>
      ...
      <p className="metric-title-line-graph-action" style={{ color: differenceColor }}>
