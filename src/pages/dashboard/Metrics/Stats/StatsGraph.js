  ...
  return (
    <ResponsiveContainer width="100%" height={370}>
      <ScatterChart margin={{ top: 20, right: 0, bottom: 20, left: 0 }}>
        ...
        <XAxis type="number" dataKey="number" name="number" tickLine={false} axisLine={false} ticks={[5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]} />
        <YAxis type="number" dataKey="value" name="value" tickLine={false} axisLine={false} ticks={[1000, 2000, 3000, 4000, 5000, 6000]} />
