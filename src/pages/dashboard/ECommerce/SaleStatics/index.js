...
const SaleStatics = () => {
  ...
  return (
    <AppCard title={messages['eCommerce.saleStatics']} extra={<AppSelect menus={[messages['dashboard.thisWeek'], messages['dashboard.lastWeeks'], messages['dashboard.lastMonth']]} defaultValue={messages['dashboard.thisWeek']} onChange={handleSelectionType} />}>
      <AppRowContainer>
        <Col xs={24} md={18}>
          <SaleStaticChart />
        </Col>
