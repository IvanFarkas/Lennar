  ...
  return (
    <AppCard heightFull className="card-hover">
      <div className="general-stats">
        <Avatar className="general-stats-avatar" style={{ backgroundColor: stats.bgcolor }}>
          {getIcon(stats.icon)}
        </Avatar>
        <div className="general-stats-content">
          ...
          <span style={{ backgroundColor: stats.bgcolor, color: stats.badgeColor }} className="general-stats-badge">
            {stats.new}
          </span>
        </div>
      </div>
