...
const MyProfile = ({ profile }) => {
  ...
  return (
    <AppCard className="my-profile-card" heightFull title={messages['academy.myProfile']}>
        ...
        <div className="my-profile-footer">
          <div className="my-profile-footer-item">
            <div className="my-profile-thumb">
              <img src={'/assets/images/dashboard/academy/achievements.png'} alt="achievements" />
            </div>
            <h4>{achievements}</h4>
