    ...
    <AppCard
      ...
      title={
        <div className="ant-row ant-row-middle">
          ...
          <AppSelect menus={[messages['dashboard.allDeals'], messages['todo.completed'], messages['common.pending']]} defaultValue={messages['dashboard.allDeals']} onChange={handleChange} />
        </div>
      }
