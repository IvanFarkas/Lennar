  ...
  return (
    <ResponsiveContainer width="100%" height={360}>
      <AreaChart data={data} margin={{ top: 50, right: 0, left: 0, bottom: 0 }}>
        <XAxis dataKey={onGetDataKey(value)} tickLine={false} axisLine={false} padding={{ left: 20, right: 20 }} />
        ...
        <Area dataKey="amount" strokeWidth={2} stackId="2" stroke="#E53E3E" fill="url(#color15)" fillOpacity={1} />
      </AreaChart>
    </ResponsiveContainer>
  );
};
