...
const TrafficSource = ({ trafficData }) => {
  ...
  return (
    <AppCard title={messages['dashboard.analytics.trafficSource']}>
      <Collapse bordered={false} defaultActiveKey={['1']} accordion className="traffic-collapse">
          ...
          <Panel
            header={
              <div className="traffic-collapse-header-panel">
                ...
                <Progress percent={data.value} strokeWidth={10} strokeColor="#0698EC" trailColor="#d6d6d6" showInfo={false} />
              </div>
            }
            key={data.id}
