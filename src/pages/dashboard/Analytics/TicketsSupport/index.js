...
const TicketsSupport = ({ tickets }) => {
  return (
    ...
    >
      <Collapse bordered={false} defaultActiveKey={['1']} accordion onChange={callback}>
        {tickets.map((data) => (
            ...
            <div className="ticket-support-collapse">
              <div className="ticket-support-collapse-item">
                ...
                <div className="ant-row ant-row-middle">
                  <Progress percent={data.overAllPercentage.open} status="active" strokeColor="#5ABE20" trailColor="rgb(214, 214, 214)" strokeWidth={5} />
                </div>
              </div>
              <div className="ticket-support-collapse-item">
                <span className="ticket-support-open">Closed</span>
                <div className="ant-row ant-row-middle">
                  <Progress percent={data.overAllPercentage.close} status="active" strokeColor="#F44D54" trailColor="rgb(214, 214, 214)" strokeWidth={5} />
                </div>
              </div>
              <div className="ticket-support-collapse-item">
                <span className="ticket-support-open">On Hold</span>
                <div className="ant-row ant-row-middle">
                  <Progress percent={data.overAllPercentage.hold} status="active" strokeColor="#F59821" trailColor="rgb(214, 214, 214)" strokeWidth={5} />
                </div>
              </div>
            </div>
          </Panel>
