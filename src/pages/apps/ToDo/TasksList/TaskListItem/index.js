...
const TaskListItem = ({ task, onChangeCheckedTasks, checkedTasks, onChangeStarred }) => {
  ...
  return (
    ...
    >
      <div className="todo-list-item-left">
        <span className="todo-list-checkbox-view" onClick={(event) => event.stopPropagation()}>
          <Checkbox checked={checkedTasks.includes(task.id)} onChange={(event) => onChangeCheckedTasks(event, task.id)} color="primary" />
        </span>

        <div className="todo-list-img-view">
          <span className="todo-list-star-view" onClick={(event) => event.stopPropagation()}>
      ...
      <div className="todo-list-item-right">
        ...
        <div className="todo-list-item-action">
          <AppIconButton onClick={onDeleteTask} title={<IntlMessages id="common.delete" />} icon={<AiOutlineDelete />} />
