    ...
    <>
      {assignedStaff ? (
        <div className="todo-assigned-staff">
          {assignedStaff.image ? <Avatar className="todo-avatar-36" src={assignedStaff.image} /> : <Avatar className="todo-avatar-36 todo-avatar-name">{assignedStaff?.name.charAt(0)}</Avatar>}
        ...
        <div className="todo-assigned-staff">
          <Avatar className="todo-avatar-36" src={'/assets/images/placeholder.jpg'} />
          <div className="todo-assigned-staff-info">
