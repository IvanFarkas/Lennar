  ...
  return (
    <div className="wall-about-item">
      ...
      <span className="wall-about-btn-view">
        <AppIconButton className="wall-about-btn" title={<IntlMessages id="common.edit" />} icon={<AiOutlineEdit />} />
      </span>
    </div>
  );
};
...
const About = ({ about }) => {
  ...
  return (
    <AppCard className="wall-about-card" title={messages['wall.about']} extra={<a href="#/">{messages['common.editPageInfo']}</a>}>
