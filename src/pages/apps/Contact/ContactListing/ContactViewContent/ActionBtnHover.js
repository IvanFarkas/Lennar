...
const ActionBtnHover = (props) => {
  ...
  return (
    <span className="contact-list-item-action-hover">
      ...
      <AppIconButton onClick={onClickEditOption} title={<IntlMessages id="common.edit" />} icon={<AiOutlineEdit />} />
      <AppIconButton onClick={onDeleteContact} title={<IntlMessages id="common.delete" />} icon={<AiOutlineDelete />} />
    </span>
  );
};
