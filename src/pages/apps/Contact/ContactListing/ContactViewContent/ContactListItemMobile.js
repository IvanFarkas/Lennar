...
const ContactListItemMobile = ({ contact, labelList, checkedContacts, onChangeStarred, onViewContactDetail, onChangeCheckedContacts }) => {
      ...
      >
        <div className="contact-list-item-main-content-mobile">
          ...
          <div className="contact-list-item-content-mobile">
            <span className="text-truncate contact-list-item-mobile-title">{contact.name}</span>

            <span className="text-truncate">{contact.contact}</span>
          </div>
        </div>
        <div className="contact-list-item-action-mobile">
          <MdLabelOutline className="contact-list-export-mobile-icon" style={{ color: onGetLabelColor(contact.label) }} />

          <span className="contact-list-item-star-mobile" onClick={(event) => event.stopPropagation()}>
