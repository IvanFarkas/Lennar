...
import { onCreateContact, onUpdateSelectedContact } from '../../../../redux/actions/ContactApp';

const AddContactForm = (props) => {
  const { userImage, selectContact, setUserImage, handleAddContactClose, onUpdateContact } = props;
  ...
  const onFinish = (values) => {
    if (values.birthday) values.birthday = moment(values.birthday).format('DD-MM-YYYY');
    if (selectContact) {
      const newContact = {
        id: selectContact.id,
  ...
  return (
    <Form
      ...
      initialValues={
        selectContact
          ? {
              ...selectContact,
              birthday: selectContact.birthday ? moment(selectContact.birthday, 'YYYY-MM-DD') : '',
            }
          : {}
      }
      onFinish={onFinish}
    ...
    >
      <div className="contact-form-header">
        ...
        {selectContact ? <h4 className="contact-form-header-title">{selectContact.name}</h4> : null}
      </div>
      ...
      <AppScrollbar className="contact-modal-scrollbar">
        <div className="contact-form-content">
          <div className="contact-form-content-item">
            ...
            <div className="contact-form-content-field">
              <Form.Item className="form-field" name="name" rules={[{ required: true, message: 'Please input your Name!' }]}>
              ...
              <Form.Item className="form-field" name="contact" rules={[{ required: true, message: 'Please input your Phone!' }]}>
        ...
        <div className="contact-form-footer">
          <Button type="primary" ghost className="contact-form-btn" onClick={handleAddContactClose}>
