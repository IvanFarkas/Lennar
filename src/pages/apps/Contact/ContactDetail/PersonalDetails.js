    ...
    <div className="contact-detail-modal-item">
      ...
      <div className="contact-detail-modal-item-content">
        <div className="contact-other-detail-item">
          ...
          <div className="contact-other-detail-item-content">{contact.email}</div>
        </div>

        <div className="contact-other-detail-item">
          <FiPhone className="contact-other-detail-item-icon" />
          <div className="contact-other-detail-item-content">{contact.contact}</div>
        </div>

        <div className="contact-other-detail-item">
          <AiOutlineGlobal className="contact-other-detail-item-icon" />
          <div className="contact-other-detail-item-content">{contact.website ? contact.website : <IntlMessages id="common.na" />}</div>
        </div>

        <div className="contact-other-detail-item">
          <AiOutlineShopping className="contact-other-detail-item-icon" />
          <div className="contact-other-detail-item-content">{contact.birthday ? contact.birthday : <IntlMessages id="common.na" />}</div>
        </div>
      </div>
    </div>
  );
