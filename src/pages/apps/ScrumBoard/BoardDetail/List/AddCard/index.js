...
const AddCard = (props) => {
  const { isModalVisible, handleCancel, /*handleOk,*/ board, list, selectedCard } = props;
  ...
  return (
    <Drawer
      ...
      // onOk={handleOk}
      title={<CardHeader onAddAttachments={onAddAttachments} onClickDeleteIcon={onClickDeleteIcon} handleCancel={handleCancel} board={board} list={list} />}
    ...
    >
      ...
      {isDeleteDialogOpen ? <AppConfirmationModal open={isDeleteDialogOpen} onDeny={setDeleteDialogOpen} onConfirm={onDeleteCard} title={<IntlMessages id="scrumboard.deleteCard" />} dialogTitle={<IntlMessages id="common.deleteItem" />} /> : null}
    </Drawer>
  );
};
