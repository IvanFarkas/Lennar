          ...
          {attachments ? (
            <div className="scrum-board-attachment">
              {attachments.map((attachment) => {
                ...
                return (
                  <div className="scrum-board-attachment-items" key={attachment.id}>
                    <div className="scrum-board-attachment-card">
                      ...
                      <div className="scrum-board-attachment-content">
                        <span className="text-truncate scrum-board-attachment-file-name">{file.name}</span>
                        <div className="scrum-board-attachment-file-time">
                          <span>{moment(file.lastModified).format('ll').split(',')[0]}</span>
                          <span>
