...
const BoardCard = ({ title, attachments = [], label = [], members, date, comments, onClick }) => {
  return (
    <AppCard
    ...
    >
      ...
      <div className="scrum-board-card-detail-user">
        ...
        <span className="scrum-board-card-detail-date">{date ? moment(date).format('ll').split(',')[0] : null}</span>
