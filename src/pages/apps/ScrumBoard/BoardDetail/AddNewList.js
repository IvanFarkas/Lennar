  ...
  return (
    <AppCard className="scrum-board-add-list-card">
      ...
      <div className="scrum-board-add-list-form-filed">
        <Input placeholder={messages['scrumboard.cardTitle']} value={listName} onChange={(event) => setListName(event.target.value)} />
        <Button type="primary" ghost className="scrum-board-add-list-btn" onClick={() => onClickAddButton()}>
