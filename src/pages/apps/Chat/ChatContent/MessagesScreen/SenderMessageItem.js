...
import { EditOutlined, FileTextOutlined, MoreOutlined, PlayCircleOutlined } from '@ant-design/icons';
...
const SenderMessageItem = ({ authUser, item, onClickEditMessage, isPreviousSender = false, deleteMessage, isLast }) => {
  ...
  return (
    <div className={clsx('chat-message-list-item right', isPreviousSender ? 'hide-user-info' : 'first-chat-message', isLast ? 'last-chat-message' : '')}>
      <div className="message-chat-view">
        ...
        <div className="message-chat-sender">
          {authUser.photoURL ? <Avatar size={34} className="message-chat-avatar" src={authUser.photoURL} /> : <Avatar className="message-chat-avatar">{getUserAvatar()}</Avatar>}
