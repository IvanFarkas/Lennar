...
const Header = (props) => {
  const { deleteConversation, selectedUser, onChangeStarred, clearChatHistory, isChecked } = props;
  ...
  return (
    <div className="chat-header">
      ...
      {isDeleteModalOpen ? <ConfirmationModal open={isDeleteModalOpen} onDeny={setDeleteModalOpen} onConfirm={onDeleteConversation} modalTitle={<IntlMessages id="chatApp.deleteContent" />} /> : null}
    </div>
  );
};
