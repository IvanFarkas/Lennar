  ...
  return (
    <div className="chat-sidebar">
      ...
      <div className="chat-sidebar-search-view">
        <Search className="chat-sidebar-search" placeholder={messages['common.searchHere']} value={keywords} onChange={(e) => setKeywords(e.target.value)} />
      </div>

      <UserTabs connectionListData={connectionListData} chatListData={chatListData} loading={loading} />
    </div>
  );
};
